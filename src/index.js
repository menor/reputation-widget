...
var ResmioRep = (function(window, undefined) {
  ...
  function detectUserLanguage() {
    // This gives us the operating system language
    var lang = navigator.language || navigator.userLanguage
    // We just want first 2 characters to convert things like en-gb or pt-br
    // as en or pt
  ...
  function getFeedbackAndRender(widget) {
    ...
    var req = makeCORSRequest('http://app.resmio.com/v1/facility/' + widget.id)
    ...
    el.innerHTML = (
      '<svg width="201" height="229" viewBox="0 0 201 229" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">' +
        ...
        '</defs>' +
          ...
          '<text x="' + feedbackPosition + '" y="152" fill="#FFF" font-family="resmioOpenSans, Open Sans" font-size="21.615" font-weight="300" letter-spacing="0.5" >' +
  ...
  function getFeedbackPosition(positiveText, feedbackScore) {
