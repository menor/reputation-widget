...
// Trim language value
// OR Set default language to navigator
...
var ResmioRep = (function(window, undefined) {
  ...
  var errors = {
    noIdFound: 'resmio reputation: no restaurant id found in the html, please provide an id in a data-resmio-reputation-id attribute'
  }

  function initialize() {
    // Widget Instances are stored here
    var widgets = getWidgetsFromThePage();
    // Call the server for the feedback score for every widget
    debugger
    // getFeedbackScore(options.id, renderElement(location, options))
    }
  ...
  function getWidgetsFromThePage() {
    ...
    for (var i = 0; i < targets.length; i++) {
      ...
      location.removeAttribute('resmio-reputation-widget');
      var options = {
        ...
        location: location,
        palette: location.getAttribute('data-resmio-reputation-color') || defaults.color
      };
      if (!options.id) {
  ...
  // function getFeedbackScore(id, cb) {
  //   // This needs to call the feedback score API endpoint instead
  //   var req = makeCORSRequest('http://test.resmio.com/v1/facility/' + id)
  ...
  //         debugger
  //         cb(res.feedback_average)
  //       } else {
  //         console.log('Feedback is not public for: ' + id)
  ...
  // var translations = {
  //   da: {
  //     headline: { text: 'TILFREDSHED', x: '59' },
  //     subline: { text: 'FRA VORES GÆSTER', x: '41' },
  ...
  //   },
  //   en: {
  //     headline: { text: 'OUR GUEST', x: '65' },
  //     subline: { text: 'SATISFACTION', x: '57' },
  //     positive: { text: 'POSITIVE' },
  //   },
  //   es: {
  //     headline: { text: 'SATISFACCIÓN DE', x: '47' },
  //     subline: { text: 'NUESTROS CLIENTES', x: '37' },
  //     positive: { text: 'POSITIVA' },
  //   },
  //   fr: {
  //     headline: { text: 'SATISFACTION DE', x: '47' },
  //     subline: { text: 'NOS CLIENTS', x: '61' },
  //     positive: { text: 'POSITIF' },
  //   },
  //   nl: {
  //     headline: { text: 'TEVREDENHEID', x: '55' },
  //     subline: { text: 'VAN ONZE GASTEN', x: '44' },
  //     positive: { text: 'POSITIV' }
  //   },
  //   pt: {
  //     headline: { text: 'SATISFAÇÃO DOS', x: '49' },
  //     subline: { text: 'NOSSOS CLIENTES', x: '45'},
  //     positive: { text: 'POSITIVA' },
  //   }
  // }
  //
